<section class="
  ...
  <img class="homepage__about__stroke__5 position-absolute start-0" src="<?php echo get_template_directory_uri() ?>/images/homepage_stroke_5.png" alt="" />
  <div class="
          ...
          position-relative
        ">
    <img class="homepage__about__stroke__2 position-absolute" src="<?php echo get_template_directory_uri() ?>/images/homepage_stroke_2.png" />
...
<section class="homepage__services__container d-flex justify-content-center px-3">
  <div class="homepage__services__content">
    ...
    <div class="d-lg-flex justify-content-between position-relative">
      <img src="<?php echo get_template_directory_uri() ?>/images/homepage_stroke_6.png" alt="" class="homepage__service__stroke__6 position-absolute" />
      <div class="
      ...
      <div id="homepage_service1" class="homepage__services__tabcontent position-relative">
        <img class="homepage__services__imageContentTab" src="<?php echo get_template_directory_uri() ?>/images/Rectangle.png" alt="" />
        ...
        <div class="
                ...
                align-items-center
              ">
          <a class="homepage__services__textBtn-1" href="<?php echo site_url('/services'); ?>">TÌM HIỂU THÊM</a>
      ...
      <div id="homepage_service2" class="homepage__services__tabcontent position-relative">
        <img class="homepage__services__imageContentTab" src="<?php echo get_template_directory_uri() ?>/images/Tangle2.jpg" alt="" />
        <div class="homepage__services__text__block">
      ...
      <div id="homepage_service3" class="homepage__services__tabcontent position-relative">
        <img class="homepage__services__imageContentTab" src="<?php echo get_template_directory_uri() ?>/images/Tangle3.jpg" alt="" />
        <div class="homepage__services__text__block">
...
<section class="d-flex justify-content-center position-relative px-3">
  <img src="<?php echo get_template_directory_uri() ?>/images/background_dot3d.gif" alt="" class="homepage__statistics__background position-absolute" />
      ...
      <div class="tab-content" id="nav-tabContent">
        <div class="
          ...
          <img src="https://wallpaperaccess.com/full/1157063.jpg" alt="" class="
                  ...
                  start-0
                " />
          <img src="<?php echo get_template_directory_uri() ?>/images/homepage_stroke_9.png" alt="" class="homepage__reviews__stroke__9 position-absolute start-0" />
          <div class="homepage__project__item__content">
            <img src="<?php echo get_template_directory_uri() ?>/images/homepage_image_iphone.png" alt="" class="homepage__project__item__image" />
    ...
    <div class="homepage___project__tablist__container">
      <div class="nav homepage___project__tablist" id="nav-tab" role="tablist">
        ...
        <div data-bs-toggle="tab" data-bs-target="#homepage__project__2" class="homepage___project__tab">
          <img src="<?php echo get_template_directory_uri() ?>/images/Rectangle.png" alt="" class="homepage___project__tab__img" />
...
<section class="
        ...
        position-relative
      ">
  <img src="<?php echo get_template_directory_uri() ?>/images/homepage_stroke_7.png" alt="" class="homepage__reviews__stroke__7 position-absolute top-0 start-0" />
  <div class="homepage__reviews__content d-flex">
    <img src="<?php echo get_template_directory_uri() ?>/images/homepage_stroke_8.png" alt="" class="homepage__reviews__stroke__8 position-absolute" />
    <div class="homepage__reviews__image position-relative">
      <img src="<?php echo get_template_directory_uri() ?>/images/customer_reviews_1.png" alt="" class="homepage__reviews__image__1" />
      <img src="<?php echo get_template_directory_uri() ?>/images/customer_reviews_2.png" alt="" class="homepage__reviews__image__2" />
      <img src="<?php echo get_template_directory_uri() ?>/images/customer_reviews_3.png" alt="" class="homepage__reviews__image__3" />
      <img src="<?php echo get_template_directory_uri() ?>/images/customer_reviews_4.png" alt="" class="homepage__reviews__image__4" />
      <img src="<?php echo get_template_directory_uri() ?>/images/customer_reviews_5.png" alt="" class="homepage__reviews__image__5" />
    </div>
...
<section class="homepage__contact__container d-flex justify-content-center px-3">
